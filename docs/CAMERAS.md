...
|-----------------|-----|----|------|
| **cafe** | کافه | 8972 | DVR ch1-8 + view_cafe_gharb(.52) + vorodi_cafe(.49) + view_cafe_shargh(.53) |
| **center11** | پذیرش و هتل | 8973 | cam_4,5,6,9,13,41 + paziresh_be_pol(.134) + paziresh_be_sahel(.135) + shargh_vorodi(.131) |
| **restaurant** | رستوران | 8975 | restoran_paeen(.136) + restoran_bala(.137) + restoran_sandogh(.14) |
| **sahel** | ساحل | 8976 | sahel_shargh(.54) + sahel_gharb_47(.47) + sahel_gharb_48(.48) |
| **villa** | ویلاها | 8977 | villa_ha(.51) + villa_ha_gharb(.12) |
| **mahoote** | محوطه | 8978 | generator(.10) |
| **center22** | پارکینگ | 8974 | parking_villa(.132) |

> رمز `1259110@av`: `.134,.135,.131,.136,.137,.51,.52,.53,.54,.47,.48,.49`
> رمز `admin123`: `.14,.12,.10,.132` (و همه‌ی cam_* مرکز و DVR کافه)

### هنوز اضافه نشده (planned — در صورت نیاز به `center22`/پارکینگ اضافه کن)
- DVR پارکینگ۴ (`192.168.51.222`) — ۵ کانال، فرمت `.sdp` (بخش ۴)
- parking3 (`.89`, `.90`) — قبلاً timeout/استریم بی‌اعتبار داشت
...
|-----|-----|--------|--------|----------|------------------------|
| `ipcam_parking3_90` | 192.168.51.90 | planned | cafe | `rtsp://admin:admin123@192.168.51.90:554/Streaming/Channels/101` | detect: `/stream1` — **تکراری IP با cam_90** |
| `ipcam_parking3_89` | 192.168.51.89 | planned | cafe | `rtsp://admin:admin123@192.168.51.89:554/Streaming/Channels/101` | detect: `/stream1` — timeout در تست قبلی |
| `ipcam_ashpazkhane_99` | 192.168.51.99 | planned | cafe | `rtsp://admin:admin123@192.168.51.99:554/Streaming/Channels/101` | H.265 — ترجیحاً H.264 روی دوربین |
| `ipcam_rest_100` | 192.168.51.100 | planned | cafe | `rtsp://admin:admin123@192.168.51.100:554/Streaming/Channels/101` | timeout در تست قبلی |
| `ipcam_rest_101` | 192.168.51.101 | planned | cafe | `rtsp://admin:admin123@192.168.51.101:554/Streaming/Channels/101` | detect: `/stream1` — timeout در تست قبلی |
...
| `cam_13` | 192.168.51.13 | **active** | `rtsp://admin:admin123@192.168.51.13:554/Streaming/Channels/102` |
...
|-----|-----|--------|------|---------|
| `cam_14` | 192.168.51.14 | **offline** | `rtsp://admin:admin123@192.168.51.14:554/Streaming/Channels/102` | timeout |
...
| نام | IP | RTSP |
|-----|-----|------|
| `cam_10` | 192.168.51.10 | `rtsp://admin:admin123@192.168.51.10:554/Streaming/Channels/102` |
| `cam_12` | 192.168.51.12 | `rtsp://admin:admin123@192.168.51.12:554/Streaming/Channels/102` |
| `cam_30` | 192.168.51.30 | `rtsp://admin:admin123@192.168.51.30:554/Streaming/Channels/102` |
| `cam_47` | 192.168.51.47 | `rtsp://admin:admin123@192.168.51.47:554/Streaming/Channels/102` |
...
| `cam_48` | 192.168.51.48 | `rtsp://admin:admin123@192.168.51.48:554/Streaming/Channels/102` |
| `cam_49` | 192.168.51.49 | `rtsp://admin:admin123@192.168.51.49:554/Streaming/Channels/102` |
| `cam_50` | 192.168.51.50 | `rtsp://admin:admin123@192.168.51.50:554/Streaming/Channels/102` |
| `cam_51` | 192.168.51.51 | `rtsp://admin:admin123@192.168.51.51:554/Streaming/Channels/102` |
| `cam_52` | 192.168.51.52 | `rtsp://admin:admin123@192.168.51.52:554/Streaming/Channels/102` |
| `cam_53` | 192.168.51.53 | `rtsp://admin:admin123@192.168.51.53:554/Streaming/Channels/102` |
| `cam_54` | 192.168.51.54 | `rtsp://admin:admin123@192.168.51.54:554/Streaming/Channels/102` |
...
| `cam_90` | 192.168.51.90 | `rtsp://admin:admin123@192.168.51.90:554/Streaming/Channels/102` — **تکراری IP با ipcam_parking3_90** |
...
| `192.168.51.90` | `ipcam_parking3_90` (کافه) | `cam_90` (مرکز) | فقط **یکی** را در **یک** Frigate فعال کن |
...
| IP کافه | 5 (همه planned) |
| IP مرکز (کل pool) | 52 |
| IP مرکز فعال | 6 |
| IP مرکز offline | 2 |
| DVR پارکینگ۴ | 5 (همه planned) |
| **جمع کل ورودی‌ها** | **71** |
