...
| `temp` | 8979 | 9 | `.21,.85,.88,.96` (بدون تصویر) + `.89,.90,.100,.101` (برگردانده‌شده) + `.95` خانه‌داری |
...
| `temp` | `cam_21`, `cam_85`, `cam_88`, `cam_96`, `cam_89`, `cam_90`, `cam_100`, `cam_101`, `cam_95` |
...
- `cam_99` (ظرف‌شویی/آشپزخانه) تعمیر شد و به `restaurant` منتقل شد.
...
| `192.168.51.95` | `cam_95` | خانه‌داری |
