...
نه نمونه‌ی دائمی + یک نمونه‌ی موقت، گروه‌بندی‌شده بر اساس محل. یوزر همه `admin`.
...
| **center22** | پارکینگ و انبار | 8974 | dvr_parking4_ch1..5(.222) + cam_8,91,92,93,94 (پارکینگ) + cam_97,98 (انبار) |
...
> - فعال در نمونه‌های دائمی: **۶۶** (cafe 10 + center11 7 + restaurant 7 + sahel 5 + villa 7 + mahoote 13 + center22 12 + tasisat 3 + entezamat 2)
