...
| نمونه | فعال | آفلاین/غیرفعال | باقی‌مانده |
|-------|------|----------------|------------|
| **cafe** | DVR ch 1,2,3,4,5,6,7,8 | — | ch10 + ۵ IP کافه |
| **center11** | cam_4,5,6,9,13,41 | cam_14, cam_16 | بقیه IP مرکز |
| **center22** | — | — | DVR parking4 + بقیه IP |
