...
| `center11` | 8973 | 9 | `.4,.5,.6,.9`(رمز جدید)`,41`، پذیرش به پل `.134`، پذیرش به ساحل `.135`، اتاق سرور `.112`، ورودی اتاق مدیریت `.11` |
| `restaurant` | 8975 | 10 | `.136,.137,.14,.13,.17,.18,.19,.99`، ورودی رستوران `.101`، درب پشت رستوران `.100` |
| `sahel` | 8976 | 4 | `.54,.47,.48,.53` |
| `villa` | 8977 | 4 | `.51,.12,.43,.44` |
| `mahoote` | 8978 | 20 | `.10,.132,.24,.25,.27,.30,.31,.50,.203,.81,.84` + `.2,.42,.45,.46` (از پارکینگ) + `.61,.62,.63,.65` (از تاسیسات) + `.71` (خروجی اصلی) |
| `center22` | 8974 | 10 | DVR پارکینگ۴ ch4 و `.8,.82,.83,.86,.91,.92,.93,.94,.96` |
| `khanedari` | 8983 | 2 | `.95` خانه‌داری، `.98` خانه‌داری |
| `tasisat` | 8980 | 1 | اتاق تاسیسات `.85`. در انتظار نصب ۱۲ دوربین جدید پارکینگ ۱. |
| `entezamat` | 8981 | 3 | `.3,.7`، کانکس ساحل `.16` |
| `anbar` | 8982 | 5 | DVR پارکینگ۴ ch1–3/ch5 + `.97` انبار |
| `temp` | 8979 | 0 | دوربین‌های باقی‌مانده **غیرفعال** (`.21,.88,.89,.90,.72`) |
...
| `center11` | `cam_4`, `cam_5`, `cam_6`, `cam_9`, `cam_11`, `cam_41`, `paziresh_be_pol`, `paziresh_be_sahel`, `cam_112` |
| `restaurant` | `restoran_paeen`, `restoran_bala`, `restoran_sandogh`, `cam_13`, `cam_17`, `cam_18`, `cam_19`, `cam_99`, `vorodi_restoran`, `darb_posht_restoran` |
| `sahel` | `sahel_shargh`, `sahel_gharb_47`, `sahel_gharb_48`, `view_cafe_shargh` |
| `villa` | `villa_ha`, `villa_ha_gharb`, `cam_43`, `cam_44` |
| `mahoote` | `generator`, `parking_villa`, `cam_24`, `cam_25`, `cam_27`, `cam_30`, `cam_31`, `cam_50`, `cam_71`, `cam_203`, `cam_81`, `cam_84`, `cam_2`, `cam_42`, `cam_45`, `cam_46`, `cam_61`, `cam_62`, `cam_63`, `cam_65` |
| `center22` | `dvr_parking4_ch4`, `cam_8`, `cam_82`, `cam_83`, `cam_86`, `cam_91` تا `cam_94`, `cam_96` |
| `khanedari` | `cam_95`, `cam_98` |
| `tasisat` | `cam_85` |
| `entezamat` | `cam_3`, `cam_7`, `cam_16` |
| `anbar` | `dvr_parking4_ch1` تا `ch3`, `dvr_parking4_ch5`, `cam_97` |
| `temp` | *(غیرفعال)* `cam_21`, `cam_88`, `cam_89`, `cam_90`, `cam_72` |
...
| `192.168.51.71` | `cam_71` | mahoote (خروجی اصلی به بیرون) |
| `192.168.51.72` | `cam_72` | temp — غیرفعال |
...
- **tasisat**: cam_64 حذف شد (بدون تصویر)؛ cam_85 (اتاق تاسیسات) از temp منتقل و فعال شد.
- **villa**: cam_20 حذف شد.
- **mahoote**: cam_71 (خروجی اصلی به بیرون، رمز `1259110@av`) از temp برگشت.
- **center22**: cam_96 از temp به پارکینگ منتقل شد.
- **temp**: دوربین‌های باقی‌مانده (`cam_21`, `cam_88`, `cam_89`, `cam_90`, `cam_72`) غیرفعال شدند.
- **temp → center11**: cam_11 (ورودی اتاق مدیریت) منتقل شد.
- **temp → restaurant**: `.101` به‌عنوان `vorodi_restoran` و `.100` به‌عنوان
  `darb_posht_restoran` منتقل شدند (رمز `admin123`، ضبط فعال).

### غیرفعال در نمونه `temp`

این‌ها دیگر استریم نمی‌شوند (`enabled: false`):

| IP | نام | توضیح |
|---|---|---|
| `192.168.51.21` | `cam_21` | غیرفعال |
| `192.168.51.88` | `cam_88` | غیرفعال |
| `192.168.51.89` | `cam_89` | پارکینگ۳ — غیرفعال |
| `192.168.51.90` | `cam_90` | پارکینگ۳ — غیرفعال |
| `192.168.51.72` | `cam_72` | ورودی اصلی به داخل — غیرفعال |

`cam_99` (ظرف‌شویی) تعمیر شد و از temp به `restaurant` منتقل شد.
`.101` (ورودی رستوران) و `.100` (درب پشت رستوران) با نام‌های `vorodi_restoran`
و `darb_posht_restoran` از temp به `restaurant` منتقل شدند و ضبط دارند.
...
| وضعیت | تعداد |
|---|---:|
| فعال در ۱۱ نمونه دائمی | **78** |
| غیرفعال در نمونه `temp` | **5** |
| planned (فقط DVR کافه ch10) | **1** |
| مجموع موجودی کارت پرتال | **84** |
| inactive در پرتال | **6** |
| broken | **0** |
