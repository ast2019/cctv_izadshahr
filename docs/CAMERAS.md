...
| ~~`cam_53`~~ | 192.168.51.53 | فعال به‌نام `view_cafe_shargh` در cafe |
...
| `192.168.51.53` | `cam_53` (planned) | `view_cafe_shargh` (cafe) | **view_cafe_shargh فعال است** |
...
> دوربین‌های فعال در همه‌ی نمونه‌ها: **۳۰** (این عدد و جمع کل با `portal/js/sites.js` → `CAMERA_INVENTORY` هماهنگ نگه داشته شود.)
