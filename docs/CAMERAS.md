...
| **mahoote** | محوطه | 8978 | generator(.10) + view_cafe_shargh(.53) |
...
| ~~`cam_53`~~ | 192.168.51.53 | فعال به‌نام `view_cafe_shargh` در mahoote |
...
| `192.168.51.53` | `cam_53` (planned) | `view_cafe_shargh` (mahoote) | **view_cafe_shargh فعال است** |
