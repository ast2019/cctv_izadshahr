...
> - فعال در نمونه‌های دائمی: **۳۶** (cafe 10 + center11 8 + restaurant 4 + sahel 5 + villa 2 + mahoote 2 + center22 5)
> - در نمونه موقت `temp` (در حال شناسایی): **۳۷**
> - planned باقی‌مانده: `dvr_cafe_ch10` (۱)
> - **مجموع = ۷۴** — inactive = ۳۸ (۳۷ temp + ch10) — broken = ۰ (خراب‌ها حذف شدند)
