...
| `mahoote` | 8978 | 19 | `.10,.132,.24,.25,.27,.30,.31,.50,.203,.81,.84` + `.2,.42,.45,.46` (از پارکینگ) + `.61,.62,.63,.65` (از تاسیسات) |
...
| `temp` | 8979 | 7 | `.21,.88,.96` (بدون تصویر) + `.89,.90` (برگردانده‌شده) + `.71,.72` (جدید) |
...
| `mahoote` | `generator`, `parking_villa`, `cam_24`, `cam_25`, `cam_27`, `cam_30`, `cam_31`, `cam_50`, `cam_203`, `cam_81`, `cam_84`, `cam_2`, `cam_42`, `cam_45`, `cam_46`, `cam_61`, `cam_62`, `cam_63`, `cam_65` |
...
| `192.168.51.71` | `cam_71` | temp (خروجی اصلی به بیرون) |
| `192.168.51.72` | `cam_72` | temp (ورودی اصلی به داخل) |
...
- **villa**: cam_20 حذف شد.
- **mahoote**: cam_153 حذف شد؛ cam_71 با رمز جدید `1259110@av` به temp رفت.
- **temp**: cam_71 (خروجی اصلی به بیرون) و cam_72 (ورودی اصلی به داخل) با رمز `1259110@av` اضافه شدند.
...
| وضعیت | تعداد |
|---|---:|
| فعال در ۱۱ نمونه دائمی | **76** |
| در نمونه موقت `temp` (در حال بررسی) | **7** |
