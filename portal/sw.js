...
const CACHE = "cctv-portal-v1.6.18";
const SHELL = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/css/fonts.css?v=1.6.18",
  "/css/main.css?v=1.6.18",
  "/js/app.js?v=1.6.18",
  "/js/sites.js?v=1.6.18",
  "/js/auth-config.js?v=1.6.18",
  "/js/changelog.js?v=1.6.18",
  "/js/changelog-ui.js?v=1.6.18",
  "/js/load-monitor.js?v=1.6.18",
  "/js/admin-panel.js?v=1.6.18",
  "/js/ambiance.js?v=1.6.18",
