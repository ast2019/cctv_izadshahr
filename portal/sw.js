...
const CACHE = "cctv-portal-v1.6.19";
const SHELL = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/css/fonts.css?v=1.6.19",
  "/css/main.css?v=1.6.19",
  "/js/app.js?v=1.6.19",
  "/js/sites.js?v=1.6.19",
  "/js/auth-config.js?v=1.6.19",
  "/js/changelog.js?v=1.6.19",
  "/js/changelog-ui.js?v=1.6.19",
  "/js/load-monitor.js?v=1.6.19",
  "/js/camera-ip-map.js?v=1.6.19",
  "/js/admin-panel.js?v=1.6.19",
  "/js/ambiance.js?v=1.6.19",
