...
const CACHE = "cctv-portal-v1.7.2";
const SHELL = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/css/fonts.css?v=1.7.2",
  "/css/main.css?v=1.7.2",
  "/js/app.js?v=1.7.2",
  "/js/sites.js?v=1.7.2",
  "/js/auth-config.js?v=1.7.2",
  "/js/changelog.js?v=1.7.2",
  "/js/changelog-ui.js?v=1.7.2",
  "/js/load-monitor.js?v=1.7.2",
  "/js/camera-ip-map.js?v=1.7.2",
  "/js/admin-panel.js?v=1.7.2",
  "/js/ambiance.js?v=1.7.2",
