...
const CACHE = "cctv-portal-v1.6.17";
const SHELL = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/css/fonts.css?v=1.6.17",
  "/css/main.css?v=1.6.17",
  "/js/app.js?v=1.6.17",
  "/js/sites.js?v=1.6.17",
  "/js/auth-config.js?v=1.6.17",
  "/js/changelog.js?v=1.6.17",
  "/js/changelog-ui.js?v=1.6.17",
  "/js/load-monitor.js?v=1.6.17",
  "/js/admin-panel.js?v=1.6.17",
  "/js/ambiance.js?v=1.6.17",
