...
const CACHE = "cctv-portal-v1.6.6";
const SHELL = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/css/fonts.css?v=1.6.6",
  "/css/main.css?v=1.6.6",
  "/js/app.js?v=1.6.6",
  "/js/sites.js?v=1.6.6",
  "/js/auth-config.js?v=1.6.6",
  "/js/changelog.js?v=1.6.6",
  "/js/changelog-ui.js?v=1.6.6",
  "/js/load-monitor.js?v=1.6.6",
  "/js/admin-panel.js?v=1.6.6",
  "/js/ambiance.js?v=1.6.6",
