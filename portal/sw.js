...
const CACHE = "cctv-portal-v1.8.1";
const SHELL = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/css/fonts.css?v=1.8.1",
  "/css/main.css?v=1.8.1",
  "/js/app.js?v=1.8.1",
  "/js/sites.js?v=1.8.1",
  "/js/auth-config.js?v=1.8.1",
  "/js/changelog.js?v=1.8.1",
  "/js/changelog-ui.js?v=1.8.1",
  "/js/load-monitor.js?v=1.8.1",
  "/js/camera-ip-map.js?v=1.8.1",
  "/js/admin-panel.js?v=1.8.1",
  "/js/ambiance.js?v=1.8.1",
