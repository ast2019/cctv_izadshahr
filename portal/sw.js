...
const CACHE = "cctv-portal-v1.6.21";
const SHELL = [
  "/",
  "/index.html",
  "/manifest.webmanifest",
  "/css/fonts.css?v=1.6.21",
  "/css/main.css?v=1.6.21",
  "/js/app.js?v=1.6.21",
  "/js/sites.js?v=1.6.21",
  "/js/auth-config.js?v=1.6.21",
  "/js/changelog.js?v=1.6.21",
  "/js/changelog-ui.js?v=1.6.21",
  "/js/load-monitor.js?v=1.6.21",
  "/js/camera-ip-map.js?v=1.6.21",
  "/js/admin-panel.js?v=1.6.21",
  "/js/ambiance.js?v=1.6.21",
